...
import { getAllActivity } from "../api/tasksApi.js";
export default function Activity() {
    ...
    if (loading)
        return <div className="page-wrapper"><div className="text-center">Loading activity...</div></div>;
    return (<div className="page-wrapper fade-in" style={{ maxWidth: "900px" }}>
      ...
      {activities.length === 0 ? (<div className="card text-center" style={{ borderStyle: "dashed", padding: "64px" }}>
          ...
          {activities.map((event) => (<div key={event.event_id} className="card accent-border" style={{ padding: "20px" }}>
