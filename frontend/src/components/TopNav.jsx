...
export default function TopNav() {
    ...
    return (<header className="app-header">
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
        ...
        <Button size="sm" variant="outline" onClick={() => setShowLogoutModal(true)} style={{ fontSize: "0.8rem", padding: "6px 12px" }}>
          Logout
        </Button>
      </div>

      <ConfirmModal isOpen={showLogoutModal} title="Logout Confirmation" message="Are you sure you want to log out?" confirmText="Yes, Logout" type="danger" onConfirm={logout} onCancel={() => setShowLogoutModal(false)}/>
    </header>);
}
